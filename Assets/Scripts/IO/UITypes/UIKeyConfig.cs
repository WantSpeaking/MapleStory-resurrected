...
namespace ms
{
	public class UIKeyConfig : UIDragElement<PosKEYCONFIG>
	{
		...
		public UIKeyConfig (Inventory in_inventory, SkillBook in_skillbook)
		{
			...
			WzObject KeyConfig = nl.nx.wzFile_ui["StatusBar3.img"]["KeyConfig"];
			...
			Texture bg = backgrnd;
			Point<short> bg_dimensions = bg.get_dimensions ();

			sprites.Add (backgrnd);
			sprites.Add (KeyConfig["backgrnd2"]);
			sprites.Add (KeyConfig["backgrnd3"]);

			WzObject BtClose3 = nl.nx.wzFile_ui["Basic.img"]["BtClose3"];
			buttons[(int)Buttons.CLOSE] = new MapleButton (BtClose3, new Point<short> ((short)(bg_dimensions.x () - 18), 3));
...
//ORIGINAL LINE: for (var const& iter : staged_mappings)
...
//ORIGINAL LINE: else if (is_action_mapping(mapping))
				else if (is_action_mapping (mapping))
				{
					...
					{
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 NOTE: 'var' variable declarations are not supported in C#:
//ORIGINAL LINE: for (var const& it : action_icons)
				...
				if (ficon != null)
				{
					if (maplekey != -1)
					{
						...
						{
							ficon.draw (position + keys_pos[fkey] - new Point<short> (0, 3));
						}
						else
						{
							if (fkey == KeyConfig.Key.LEFT_CONTROL || fkey == KeyConfig.Key.RIGHT_CONTROL)
							{
								ficon.draw (position + keys_pos[KeyConfig.Key.LEFT_CONTROL] - new Point<short> (2, 3));
								ficon.draw (position + keys_pos[KeyConfig.Key.RIGHT_CONTROL] - new Point<short> (2, 3));
							}
							else if (fkey == KeyConfig.Key.LEFT_ALT || fkey == KeyConfig.Key.RIGHT_ALT)
							{
								ficon.draw (position + keys_pos[KeyConfig.Key.LEFT_ALT] - new Point<short> (2, 3));
								ficon.draw (position + keys_pos[KeyConfig.Key.RIGHT_ALT] - new Point<short> (2, 3));
							}
							else if (fkey == KeyConfig.Key.LEFT_SHIFT || fkey == KeyConfig.Key.RIGHT_SHIFT)
							{
								ficon.draw (position + keys_pos[KeyConfig.Key.LEFT_SHIFT] - new Point<short> (2, 3));
								ficon.draw (position + keys_pos[KeyConfig.Key.RIGHT_SHIFT] - new Point<short> (2, 3));
							}
							else
							{
								ficon.draw (position + keys_pos[fkey] - new Point<short> (2, 3));
							}
						}
					}
				}
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: UI::get().drag_icon(icon);
...
//ORIGINAL LINE: return UIElement::send_cursor(clicked, cursorpos);
		...
		public override bool send_icon (Icon icon, Point<short> cursorpos)
		{
			...
			{
				Rectangle<short> icon_rect = new Rectangle<short> (position + iter.Value, position + iter.Value + new Point<short> (32, 32));

				if (icon_rect.contains (cursorpos))
				{
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: icon.drop_on_bindings(cursorpos, true);
...
//ORIGINAL LINE: UIElement::Type get_type() const override
		...
		/// Keymap Staging
		public void stage_mapping (Point<short> cursorposition, Keyboard.Mapping mapping)
		{
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: KeyConfig::Key key = key_by_position(cursorposition);
			KeyConfig.Key key = key_by_position (cursorposition);
			Keyboard.Mapping prior_staged = staged_mappings[(int)key];
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: unstage_mapping(prior_staged);
			unstage_mapping (prior_staged);

//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: if (is_action_mapping(mapping))
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 TODO TASK: Lambda expressions cannot be assigned to 'var':
		...
		private void load_keys_pos ()
		{
			...
			keys_pos[KeyConfig.Key.ESCAPE] = new Point<short> (row_one_x, row_special_y);
			...
			for (int i = (int)KeyConfig.Key.F1; i <= (int)KeyConfig.Key.F12; i++)
			{
				...
				keys_pos[id] = new Point<short> (row_special_x, row_special_y);
			...
			keys_pos[KeyConfig.Key.SCROLL_LOCK] = new Point<short> ((short)(row_quickslot_x + (slot_width * 1)), row_special_y);

			keys_pos[KeyConfig.Key.GRAVE_ACCENT] = new Point<short> ((short)(row_one_x + (slot_width * 0)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM1] = new Point<short> ((short)(row_one_x + (slot_width * 1)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM2] = new Point<short> ((short)(row_one_x + (slot_width * 2)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM3] = new Point<short> ((short)(row_one_x + (slot_width * 3)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM4] = new Point<short> ((short)(row_one_x + (slot_width * 4)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM5] = new Point<short> ((short)(row_one_x + (slot_width * 5)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM6] = new Point<short> ((short)(row_one_x + (slot_width * 6)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM7] = new Point<short> ((short)(row_one_x + (slot_width * 7)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM8] = new Point<short> ((short)(row_one_x + (slot_width * 8)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM9] = new Point<short> ((short)(row_one_x + (slot_width * 9)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.NUM0] = new Point<short> ((short)(row_one_x + (slot_width * 10)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.MINUS] = new Point<short> ((short)(row_one_x + (slot_width * 11)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.EQUAL] = new Point<short> ((short)(row_one_x + (slot_width * 12)), (short)(row_y + (slot_height * 0)));

			for (int i = (int)KeyConfig.Key.Q; i <= (int)KeyConfig.Key.RIGHT_BRACKET; i++)
			{
				KeyConfig.Key id = KeyConfig.actionbyid (i);

				keys_pos[id] = new Point<short> ((short)(row_two_x + (slot_width * (int)(i - (int)KeyConfig.Key.Q))), (short)(row_y + (slot_height * 1)));
			}

			row_two_x += 9;

			keys_pos[KeyConfig.Key.BACKSLASH] = new Point<short> ((short)(row_two_x + (slot_width * 12)), (short)(row_y + (slot_height * 1)));

			for (int i = (int)KeyConfig.Key.A; i <= (int)KeyConfig.Key.APOSTROPHE; i++)
			{
				KeyConfig.Key id = KeyConfig.actionbyid (i);

				keys_pos[id] = new Point<short> ((short)(row_three_x + (slot_width * (int)(i - (int)KeyConfig.Key.A))), (short)(row_y + (slot_height * 2)));
			}

			keys_pos[KeyConfig.Key.LEFT_SHIFT] = new Point<short> ((short)(row_four_x + (slot_width * 0)), (short)(row_y + (slot_height * 3)));
			...
			for (int i = (int)KeyConfig.Key.Z; i <= (int)KeyConfig.Key.PERIOD; i++)
			{
				...
				keys_pos[id] = new Point<short> ((short)(row_four_x + (slot_width * (int)(i - (int)KeyConfig.Key.Z + 1))), (short)(row_y + (slot_height * 3)));
			}

			row_four_x += 24;

			keys_pos[KeyConfig.Key.RIGHT_SHIFT] = new Point<short> ((short)(row_four_x + (slot_width * 11)), (short)(row_y + (slot_height * 3)));

			keys_pos[KeyConfig.Key.LEFT_CONTROL] = new Point<short> ((short)(row_five_x + (slot_width_lg * 0)), (short)(row_y + (slot_height * 4)));
			keys_pos[KeyConfig.Key.LEFT_ALT] = new Point<short> ((short)(row_five_x + (slot_width_lg * 1)), (short)(row_y + (slot_height * 4)));

			row_five_x += 24;

			keys_pos[KeyConfig.Key.SPACE] = new Point<short> ((short)(row_five_x + (slot_width_lg * 2)), (short)(row_y + (slot_height * 4)));

			row_five_x += 27;

			keys_pos[KeyConfig.Key.RIGHT_ALT] = new Point<short> ((short)(row_five_x + (slot_width_lg * 3)), (short)(row_y + (slot_height * 4)));

			row_five_x += 2;

			keys_pos[KeyConfig.Key.RIGHT_CONTROL] = new Point<short> ((short)(row_five_x + (slot_width_lg * 4)), (short)(row_y + (slot_height * 4)));

			keys_pos[KeyConfig.Key.INSERT] = new Point<short> ((short)(row_quickslot_x + (slot_width * 0)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.HOME] = new Point<short> ((short)(row_quickslot_x + (slot_width * 1)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.PAGE_UP] = new Point<short> ((short)(row_quickslot_x + (slot_width * 2)), (short)(row_y + (slot_height * 0)));
			keys_pos[KeyConfig.Key.DELETE] = new Point<short> ((short)(row_quickslot_x + (slot_width * 0)), (short)(row_y + (slot_height * 1)));
			keys_pos[KeyConfig.Key.END] = new Point<short> ((short)(row_quickslot_x + (slot_width * 1)), (short)(row_y + (slot_height * 1)));
			keys_pos[KeyConfig.Key.PAGE_DOWN] = new Point<short> ((short)(row_quickslot_x + (slot_width * 2)), (short)(row_y + (slot_height * 1)));
		}
		...
		private void load_unbound_actions_pos ()
		{
			...
			unbound_actions_pos[KeyAction.Id.MAPLECHAT] = new Point<short> ((short)(row_x + (slot_width * 0)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.TOGGLECHAT] = new Point<short> ((short)(row_x + (slot_width * 1)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.WHISPER] = new Point<short> ((short)(row_x + (slot_width * 2)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.MEDALS] = new Point<short> ((short)(row_x + (slot_width * 3)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.BOSSPARTY] = new Point<short> ((short)(row_x + (slot_width * 4)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.PROFESSION] = new Point<short> ((short)(row_x + (slot_width * 5)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.EQUIPMENT] = new Point<short> ((short)(row_x + (slot_width * 6)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.ITEMS] = new Point<short> ((short)(row_x + (slot_width * 7)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.CHARINFO] = new Point<short> ((short)(row_x + (slot_width * 8)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.MENU] = new Point<short> ((short)(row_x + (slot_width * 9)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.QUICKSLOTS] = new Point<short> ((short)(row_x + (slot_width * 10)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.PICKUP] = new Point<short> ((short)(row_x + (slot_width * 11)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.SIT] = new Point<short> ((short)(row_x + (slot_width * 12)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.ATTACK] = new Point<short> ((short)(row_x + (slot_width * 13)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.JUMP] = new Point<short> ((short)(row_x + (slot_width * 14)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.INTERACT_HARVEST] = new Point<short> ((short)(row_x + (slot_width * 15)), (short)(row_y + (slot_height * 0)));
			unbound_actions_pos[KeyAction.Id.SOULWEAPON] = new Point<short> ((short)(row_x + (slot_width * 16)), (short)(row_y + (slot_height * 0)));

			unbound_actions_pos[KeyAction.Id.SAY] = new Point<short> ((short)(row_x + (slot_width * 0)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.PARTYCHAT] = new Point<short> ((short)(row_x + (slot_width * 1)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.FRIENDSCHAT] = new Point<short> ((short)(row_x + (slot_width * 2)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.ITEMPOT] = new Point<short> ((short)(row_x + (slot_width * 3)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.EVENT] = new Point<short> ((short)(row_x + (slot_width * 4)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.SILENTCRUSADE] = new Point<short> ((short)(row_x + (slot_width * 5)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.STATS] = new Point<short> ((short)(row_x + (slot_width * 6)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.SKILLS] = new Point<short> ((short)(row_x + (slot_width * 7)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.QUESTLOG] = new Point<short> ((short)(row_x + (slot_width * 8)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.CHANGECHANNEL] = new Point<short> ((short)(row_x + (slot_width * 9)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.GUILD] = new Point<short> ((short)(row_x + (slot_width * 10)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.PARTY] = new Point<short> ((short)(row_x + (slot_width * 11)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.NOTIFIER] = new Point<short> ((short)(row_x + (slot_width * 12)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.FRIENDS] = new Point<short> ((short)(row_x + (slot_width * 13)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.WORLDMAP] = new Point<short> ((short)(row_x + (slot_width * 14)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.MINIMAP] = new Point<short> ((short)(row_x + (slot_width * 15)), (short)(row_y + (slot_height * 1)));
			unbound_actions_pos[KeyAction.Id.KEYBINDINGS] = new Point<short> ((short)(row_x + (slot_width * 16)), (short)(row_y + (slot_height * 1)));

			unbound_actions_pos[KeyAction.Id.GUILDCHAT] = new Point<short> ((short)(row_x + (slot_width * 0)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.ALLIANCECHAT] = new Point<short> ((short)(row_x + (slot_width * 1)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.BATTLEANALYSIS] = new Point<short> ((short)(row_x + (slot_width * 2)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.GUIDE] = new Point<short> ((short)(row_x + (slot_width * 3)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.ENHANCEEQUIP] = new Point<short> ((short)(row_x + (slot_width * 4)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.MONSTERCOLLECTION] = new Point<short> ((short)(row_x + (slot_width * 5)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.MANAGELEGION] = new Point<short> ((short)(row_x + (slot_width * 6)), (short)(row_y + (slot_height * 2)));
			//unbound_actions_pos[KeyAction::Id::LENGTH] = Point<int16_t>((short)(row_x + (slot_width * 7), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.MAPLENEWS] = new Point<short> ((short)(row_x + (slot_width * 8)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.CASHSHOP] = new Point<short> ((short)(row_x + (slot_width * 9)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.MAINMENU] = new Point<short> ((short)(row_x + (slot_width * 10)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.SCREENSHOT] = new Point<short> ((short)(row_x + (slot_width * 11)), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.PICTUREMODE] = new Point<short> ((short)(row_x + (slot_width * 12)), (short)(row_y + (slot_height * 2)));
			//unbound_actions_pos[KeyAction::Id::LENGTH] = Point<int16_t>((short)(row_x + (slot_width * 13), (short)(row_y + (slot_height * 2)));
			unbound_actions_pos[KeyAction.Id.MUTE] = new Point<short> ((short)(row_x + (slot_width * 14)), (short)(row_y + (slot_height * 2)));
			...
			unbound_actions_pos[KeyAction.Id.FACE1] = new Point<short> ((short)(row_x + (slot_width * 0)), (short)(row_y + (slot_height * 3)));
			unbound_actions_pos[KeyAction.Id.FACE2] = new Point<short> ((short)(row_x + (slot_width * 1)), (short)(row_y + (slot_height * 3)));
			unbound_actions_pos[KeyAction.Id.FACE3] = new Point<short> ((short)(row_x + (slot_width * 2)), (short)(row_y + (slot_height * 3)));
			unbound_actions_pos[KeyAction.Id.FACE4] = new Point<short> ((short)(row_x + (slot_width * 3)), (short)(row_y + (slot_height * 3)));
			unbound_actions_pos[KeyAction.Id.FACE5] = new Point<short> ((short)(row_x + (slot_width * 4)), (short)(row_y + (slot_height * 3)));
			unbound_actions_pos[KeyAction.Id.FACE6] = new Point<short> ((short)(row_x + (slot_width * 5)), (short)(row_y + (slot_height * 3)));
			unbound_actions_pos[KeyAction.Id.FACE7] = new Point<short> ((short)(row_x + (slot_width * 6)), (short)(row_y + (slot_height * 3)));
			unbound_actions_pos[KeyAction.Id.MAPLEACHIEVEMENT] = new Point<short> ((short)(row_x + (slot_width * 7)), (short)(row_y + (slot_height * 3)));
			unbound_actions_pos[KeyAction.Id.MONSTERBOOK] = new Point<short> ((short)(row_x + (slot_width * 8)), (short)(row_y + (slot_height * 3)));
			unbound_actions_pos[KeyAction.Id.TOSPOUSE] = new Point<short> ((short)(row_x + (slot_width * 9)), (short)(row_y + (slot_height * 3)));
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 TODO TASK: Lambda expressions cannot be assigned to 'var':
		...
		/// Helpers
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: Texture get_item_texture(int item_id) const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: Texture get_skill_texture(int skill_id) const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: KeyConfig::Key key_by_position(Point<short> cursorpos) const
		private KeyConfig.Key key_by_position (Point<short> cursorpos)
		{
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: KeyAction::Id unbound_action_by_position(Point<short> cursorpos) const
		private KeyAction.Id unbound_action_by_position (Point<short> cursorpos)
		{
			foreach (var iter in unbound_actions_pos)
			{
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: Keyboard::Mapping get_staged_mapping(int keycode) const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: bool is_action_mapping(Keyboard::Mapping mapping) const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: void drop_on_bindings(Point<short> cursorposition, bool remove) const override
			public override void drop_on_bindings (Point<short> cursorposition, bool remove)
			{
				var keyconfig = UI.get ().get_element<UIKeyConfig> ();
		...
		{
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: base(m);
			public CountableMappingIcon (Keyboard.Mapping m, short c) : base (m)
			{
				this.count = c;
			}
		...
		private EnumMap<KeyConfig.Key, Point<short>> keys_pos = new EnumMap<KeyConfig.Key, Point<short>> ();

		private EnumMap<KeyAction.Id, Icon> action_icons = new EnumMap<KeyAction.Id, Icon> ();
		private EnumMap<KeyAction.Id, Point<short>> unbound_actions_pos = new EnumMap<KeyAction.Id, Point<short>> ();
