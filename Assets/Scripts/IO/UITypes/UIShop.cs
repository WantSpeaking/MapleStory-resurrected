...
namespace ms
{
	public class UIShop : UIDragElement<PosSHOP>
	{
		...
		public UIShop(CharLook in_charlook, Inventory in_inventory)
		{
			...
			WzObject src = nl.nx.wzFile_ui["UIWindow2.img"]["Shop2"];
			...
			Point<short> cb_origin = cben.get_origin();
			...
			buttons[(int)Buttons.CHECKBOX] = new AreaButton(new Point<short>(Math.Abs(cb_x), Math.Abs(cb_y)), cben.get_dimensions());
			...
			{
				Point<short> pos = new Point<short>(buy_x, (short)(item_y + 42 * (i - (int)Buttons.BUY0)));
				Point<short> dim = new Point<short>(buy_width, item_height);
			...
			{
				Point<short> pos = new Point<short>(sell_x, (short)(item_y + 42 * (i - (int)Buttons.SELL0)));
				Point<short> dim = new Point<short>(sell_width, item_height);
				buttons[i] = new AreaButton(pos, dim);
			}
			...
			buyslider = new Slider((int)Slider.Type.DEFAULT_SILVER, new Range<short>(123, 484), 257, 5, 1, (bool upwards) =>
			{
			...
			sellslider = new Slider((int)Slider.Type.DEFAULT_SILVER, new Range<short>(123, 484), 488, 5, 1, (bool upwards) =>
			{
					short shift = (short)(upwards ? -1 : 1);
...
//ORIGINAL LINE: dimension = bg_dimensions;
			...
			dragarea = new Point<short>(bg_dimensions.x(), 10);
		}
...
//ORIGINAL LINE: void draw(float alpha) const override
		public override void draw(float alpha)
		{
			...
			npc.draw(new DrawArgument(position + new Point<short>(58, 85), true));
			charlook.draw(position + new Point<short>(338, 85), false, Stance.Id.STAND1, Expression.Id.DEFAULT);

			mesolabel.draw(position + new Point<short>(493, 51));

//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: buystate.draw(position, buy_selection);
			buystate.draw(position, buy_selection);
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: sellstate.draw(position, sell_selection);
			sellstate.draw(position, sell_selection);

//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: buyslider.draw(position);
			buyslider.draw(position);
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: sellslider.draw(position);
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created if it does not yet exist:
//ORIGINAL LINE: lastcursorpos = cursoroffset;
			lastcursorpos=(cursoroffset);

			if (buyslider.isenabled())
			{
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: Cursor::State bstate = buyslider.send_cursor(cursoroffset, clicked);
			...
			{
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: Cursor::State sstate = sellslider.send_cursor(cursoroffset, clicked);
		...
		public override void rightclick(Point<short> cursorpos)
		{
			if (rightclicksell)
			{
				Point<short> cursoroffset = cursorpos - position;
...
//ORIGINAL LINE: UIElement::Type get_type() const override
		...
		public void reset(int npcid)
		{
			...
			npc = nl.nx.wzFile_npc[strid + ".img"]["stand"]["0"];
		...
		{
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: var buyitem = BuyItem(meso, id, price, pitch, time, chargeprice, buyable);
			var buyitem = new BuyItem(meso, id, price, pitch, time, chargeprice, buyable);
		...
		static readonly Range<ushort> buy = new Range<ushort>((ushort)Buttons.BUY0, (ushort)Buttons.BUY8);
		static readonly Range<ushort> sell = new Range<ushort>((ushort)Buttons.SELL0, (ushort)Buttons.SELL8);
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: sellstate.change_tab(inventory, type, meso);
		...
		private Point<short> lastcursorpos = new Point<short>();
		...
		private class BuyItem
		{
			...
			{
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: this.currency = new ms.Texture(cur);
				this.currency = cur;
				this.id = i;
				this.price = p;
				this.pitch = pt;
				...
				{
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created if it does not yet exist:
//ORIGINAL LINE: icon = item.get_icon(false);
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: void draw(Point<short> pos) const
			public void draw(Point<short> pos)
			{
				icon.draw(pos + new Point<short>(0, 42));
				namelabel.draw(pos + new Point<short>(40, 6));
				currency.draw(pos + new Point<short>(38, 29));
				pricelabel.draw(pos + new Point<short>(55, 24));
			}
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: short get_buyable() const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created if it does not yet exist:
//ORIGINAL LINE: icon = idata.get_icon(false);
...
//ORIGINAL LINE: void draw(Point<short> pos) const
			public void draw(Point<short> pos)
			{
				icon.draw(pos + new Point<short>(43, 42));

				if (showcount)
				{
					Charset countset = new Charset(nl.nx.wzFile_ui["Basic.img"]["ItemNo"], Charset.Alignment.LEFT);
					countset.draw(Convert.ToString(sellable), pos + new Point<short>(41, 28));
				}

				namelabel.draw(pos + new Point<short>(84, 6));
				pricelabel.draw(pos + new Point<short>(84, 24));
			}
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: short get_slot() const
			public short get_slot()
			{
				return slot;
			}
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: short get_sellable() const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: void draw(Point<short> parentpos, const Texture& selected) const
			public void draw(Point<short> parentpos, Texture selected)
			{
				for (short i = 0; i < 9; i++)
				{
					...
					var itempos = new Point<short>(12, (short)(116 + 42 * i));

					if (slot == selection)
					{
						selected.draw(parentpos + itempos + new Point<short>(35, 8));
					}
...
//ORIGINAL LINE: void draw(Point<short> parentpos, const Texture& selected) const
			public void draw(Point<short> parentpos, Texture selected)
			{
				for (short i = 0; i <= 8; i++)
				{
					...
					Point<short> itempos = new Point<short>(243, (short)(116 + 42 * i));

					if (slot == selection)
					{
						selected.draw(parentpos + itempos + new Point<short>(78, 8));
					}
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: void sell(bool skip_confirmation) const
