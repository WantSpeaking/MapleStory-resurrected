...
//ORIGINAL LINE: bool operator ==(const Mapping& other) const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: ClassicMap<int, Keyboard::Mapping> get_maplekeys() const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: KeyAction::Id get_ctrl_action(int keycode) const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: Keyboard::Mapping get_mapping(int keycode) const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: Keyboard::Mapping get_maple_mapping(int keycode) const
...
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: 'const' methods are not available in C#:
//ORIGINAL LINE: Keyboard::Mapping get_text_mapping(int keycode, bool shift) const
