...
//ORIGINAL LINE: void draw(Point<short> parentpos) const
		public void draw(Point<short> parentpos)
		{
			l.draw(parentpos + new Point<short>(-1, 0));
			r.draw(parentpos + new Point<short>(1, 0));
			t.draw(parentpos + new Point<short>(0, -1));
			b.draw(parentpos + new Point<short>(0, 1));
...
//ORIGINAL LINE: void draw(Point<short> parentpos) const
		public void draw(Point<short> parentpos)
		{
			shadow.draw(parentpos + new Point<short>(1, 1));
			top.draw(parentpos);
		}
