...
namespace constants.skills
{
	...
	public class Aran
	{
        ...
        public const int COMBO_ABILITY = 21000000;    //矛连击强化
        public const int COMBAT_STEP = 21001001;      //双重重击
        public const int DOUBLE_SWING = 21000002;     //战斗步伐
        public const int POLEARM_BOOSTER = 21001003;  //快速矛

        public const int POLEARM_MASTER = 21100000;
        public const int TRIPLE_SWING = 21100001;
        public const int ARAN_RUSH = 21100002;
        public const int BODY_PRESSURE = 21101003;
        public const int COMBO_SMASH = 21100004;
        public const int COMBO_DRAIN = 21100005;
        public const int 抗压 = 21101003;

        public const int COMBO_CRITICAL = 21110000;
        public const int FULL_SWING = 21110002;
        public const int 终极投掷 = 21110003;
        ...
        public const int 巨熊咆哮 = 21120005;
