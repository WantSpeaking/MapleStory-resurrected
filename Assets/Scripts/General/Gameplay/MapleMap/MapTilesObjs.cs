...
namespace ms
{
    ...
    public class MapTilesObjs
    {
        ...
        public MapTilesObjs (MapleData node_100000000img)
        {
        ...
        public EnumMapNew<Layer.Id, TilesObjs> get_layers() => layers;
        private EnumMapNew<Layer.Id, TilesObjs> layers = new EnumMapNew<Layer.Id, TilesObjs>();
    }
}
