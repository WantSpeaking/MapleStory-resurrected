...
namespace ms
{
    ...
    {
        private static readonly MapleDataProvider mapleData = wz.wzProvider_map;
        ...
        public Background(MapleData src, bool front)////back1stChildMap/Map1/100000000.img/back/0
        {
            ...
            string bsImg = $"Back/{src["bS"]}.img";
            string ani_or_back = animated ? "ani" : "back";
            string no = src["no"];

            var ani_data = mapleData.getData(bsImg)?[ani_or_back]?[no];
