...
namespace HaCreator.MapSimulator
{
    ...
    public class MapSimulator/* : Microsoft.Xna.Framework.Game*/
    {
        ...
        public GraphicsDeviceManager _DxDeviceManager;
        ...
        public MapSimulator(Board mapBoard, string titleName)
        {
            ...
            _DxDeviceManager = new GraphicsDeviceManager(this)
            {
                ...
                PreferredBackBufferFormat = SurfaceFormat.Color/* | SurfaceFormat.Bgr32 | SurfaceFormat.Dxt1| SurfaceFormat.Dxt5#1#,
        ...
        public void LoadContent()
        {
            ...
            WzDirectory UIWZFile = Program.WzManager["UI-new"];
        ...
        public void Update(GameTime gameTime, ms.Camera camera)
        {
            ...
            var playerPos = camera.position(1);
            mapShiftX = playerPos.x();
            mapShiftY = playerPos.y();
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            //Console.WriteLine($"mapShiftX:{mapShiftX} mapShiftY:{mapShiftY} mapCenterX:{mapCenterX} mapCenterY:{mapCenterY} RenderWidth:{RenderWidth} RenderHeight:{RenderHeight} TickCount:{TickCount}");
       ...
       /*     sprite.Draw(texture_vrBoundaryRectTop, 
        ...
        private void DoScreenshot()
        {
            if (bSaveScreenshot)
            {
                ...
                //Copy to texture
                using (Texture2D texture = new Texture2D(GraphicsDevice, backBufferWidth, backBufferHeight, false, SurfaceFormat.Color  /*RGBA8888#1#))
                {
