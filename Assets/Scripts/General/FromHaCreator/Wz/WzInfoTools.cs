...
namespace HaCreator.Wz
{
    ...
    {
        /*public static MapleLib.WzLib.Point PointFToSystemPoint (PointF source)
        {
            return new MapleLib.WzLib.Point ((int)source.X, (int)source.Y);
        }

        public static MapleLib.WzLib.Point VectorToSystemPoint (WzVectorProperty source)
        {
            return new MapleLib.WzLib.Point (source.X.Value, source.Y.Value);
        }*/
        ...
        public static WzVectorProperty PointToVector (string name, MapleLib.WzLib.Point source)
        {
