...
namespace HaCreator.MapEditor.Info
{
    public class PortalInfo : MapleDrawableInfo
    {
        ...
        public PortalInfo(string type, Bitmap image, MapleLib.WzLib.Point origin, WzObject parentObject)
        ...
        public static PortalInfo Load(WzCanvasProperty parentObject)
        {
            PortalInfo portal = new PortalInfo(
                ...
                WzInfoTools.PointFToPoint(parentObject.GetCanvasOriginPosition()), parentObject);
