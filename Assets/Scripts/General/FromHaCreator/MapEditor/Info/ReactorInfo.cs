...
namespace HaCreator.MapEditor.Info
{
    public class ReactorInfo : MapleExtractableInfo
    {
        ...
        public ReactorInfo(Bitmap image, MapleLib.WzLib.Point origin, string id, WzObject parentObject)
        ...
        private void ExtractPNGFromImage(WzImage image)
        {
            ...
            if (reactorImage != null)
            {
                ...
                Origin = WzInfoTools.PointFToPoint(reactorImage.GetCanvasOriginPosition());
            }
            else
            {
        ...
        {
            return new ReactorInfo(null, new MapleLib.WzLib.Point(), WzInfoTools.RemoveExtension(parentObject.Name), parentObject);
        }
