...
namespace HaCreator.MapEditor.Info
{
    public class TileInfo : MapleDrawableInfo
    {
        ...
        public TileInfo(Bitmap image, MapleLib.WzLib.Point  origin, string tS, string u, string no, int mag, int z, WzObject parentObject)
        ...
        private static TileInfo Load(WzCanvasProperty parentObject, string tS, string u, string no, int? mag)
        {
            ...
            TileInfo result = new TileInfo(
                ...
                WzInfoTools.PointFToPoint(parentObject.GetCanvasOriginPosition()),
