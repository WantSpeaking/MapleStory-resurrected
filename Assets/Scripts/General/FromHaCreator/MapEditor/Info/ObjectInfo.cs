...
namespace HaCreator.MapEditor.Info
{
    public class ObjectInfo : MapleDrawableInfo
    {
        ...
        public ObjectInfo(Bitmap image, MapleLib.WzLib.Point origin, string oS, string l0, string l1, string l2, WzObject parentObject)
        ...
        private static ObjectInfo Load(WzSubProperty parentObject, string oS, string l0, string l1, string l2)
        {
            ...
            ObjectInfo result = new ObjectInfo(
                ...
                WzInfoTools.PointFToPoint(frame1.GetCanvasOriginPosition()),
                oS,
                l0,
                l1,
                l2,
