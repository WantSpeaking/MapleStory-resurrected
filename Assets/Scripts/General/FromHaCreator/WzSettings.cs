...
namespace HaCreator
{
    public static class UserSettings
    {
        ...
        public static RenderResolution SimulateResolution = RenderResolution.Res_1280x720; // combo box selection. 800x600, 1024x768, 1280x720, 1920x1080
        public static bool ClipText = false;
        public static Color TabColor = Color.Black;
        ...
        //public static MapleLib.WzLib.FontStyle FontStyle = MapleLib.WzLib.FontStyle.Regular;
    ...
    public static class ApplicationSettings
    {
        ...
        public static MapleLib.WzLib.Size LastMapSize = new MapleLib.WzLib.Size(800, 800);
