...
namespace MapleLib.WzLib
{
    ...
    public class WzFile : WzObject
    {
        ...
        public WzFileParseStatus ParseWzFile (byte[] WzIv = null)
        {
	        ...
	        return ParseMainWzDirectory (out _, lazyParse:false)? WzFileParseStatus.Success: WzFileParseStatus.Error_Game_Ver_Hash;
        }
        ...
        public bool ParseWzFile(out string parseErrorMessage, byte[] WzIv = null)
        {
            ...
            bool parseSuccess = ParseMainWzDirectory(out parseErrorMessage, lazyParse:false);
