                ...
                if (settingProp == null)
                ...
                else switch (fieldInfo.FieldType.FullName)
                    {
                        ...
                        case "Microsoft.Xna.Framework.Color":
                            ...
                            break;
                        case "MapleLib.WzLib.Color":
                            argb = BitConverter.GetBytes((uint)((WzDoubleProperty)settingProp).Value);
                            fieldInfo.SetValue(null, MapleLib.WzLib.Color.FromArgb(argb[3], argb[2], argb[1], argb[0]));
                            break;
                        case "System.Int32":
                            fieldInfo.SetValue(null, InfoTool.GetInt(settingProp));
                            break;
                        ...
                        case "ItemTypes":
                            ...
                            break;*/
                        case "MapleLib.WzLib.Size":
                            fieldInfo.SetValue(null, new MapleLib.WzLib.Size(((WzVectorProperty)settingProp).X.Value, ((WzVectorProperty)settingProp).Y.Value));
                            break;
                        case "System.String":
                            fieldInfo.SetValue(null, InfoTool.GetString(settingProp));
                            break;
                        case "MapleLib.WzLib.Bitmap":
            ...
            if (fieldInfo.FieldType.BaseType != null && fieldInfo.FieldType.BaseType.FullName == "System.Enum")
            ...
            else switch (fieldInfo.FieldType.FullName)
                {
                    ...
                    case "Microsoft.Xna.Framework.Color":
                        ...
                        break;
                    case "MapleLib.WzLib.Color":
                        SetWzProperty(settingsImage, settingName, WzPropertyType.Double,/* (double)*/((MapleLib.WzLib.Color)fieldInfo.GetValue(null))/*.ToArgb()*/);
                        break;
                    case "System.Int32":
                        SetWzProperty(settingsImage, settingName, WzPropertyType.Int, fieldInfo.GetValue(null));
                        break;
