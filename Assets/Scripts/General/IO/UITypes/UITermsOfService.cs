...
namespace ms
{
	...
	public class UITermsOfService : UIElement
	{
		...
		public UITermsOfService(System.Action oh)
		{
			...
			buttons[(int)Buttons.OK] = new MapleButton(Login["BtOk"], new Point_short(483, 425));
			buttons[(int)Buttons.CANCEL] = new MapleButton(Login["BtCancel"], new Point_short(557, 425));
...
#region EULA
			...
			slider = new Slider((int)Slider.Type.LINE_PUNGA, new Range_short(slider_y, (short)(slider_y + 305)), 574, unit_rows, max_rows, (bool upwards) =>
			{
		...
		public override void draw(float inter)
		{
			...
			short range_min = 80;
			text.draw(position + new Point_short(226, (short)(84 - offset * 300)), new Range_short(range_min, (short)(range_min + 316)));
		...
		public override Cursor.State send_cursor(bool clicked, Point_short cursorpos)
		{
			...
			if (slider.isenabled())
			{
				Cursor.State state = slider.send_cursor(new Point_short (cursoroffset), clicked);
