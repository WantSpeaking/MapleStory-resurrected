	...
	public class UIChatBar : UIDragElement<PosCHAT>
	{
		...
		public UIChatBar () : base (new Point_short (410, -5))
		{
			...
			chatfield.set_key_callback (KeyAction.Id.DOWN, () =>
		   {
			...
			ms_Unity.FGUI_Manager.Instance.OpenFGUI<ms_Unity.FGUI_ChatBar> ();
		}
...
*/
		...
		public void Focus_chatfield()
		{
			chatfield.set_state (Textfield.State.FOCUSED);
		}
		public void UnFocus_chatfield ()
		{
		...
		public Dictionary<short, Text> rowtexts = new Dictionary<short, Text> ();
