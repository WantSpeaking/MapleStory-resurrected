                    ...
                    foreach (var property_00002000img_alert_0 in property_00002000img_alert)
                    {
                        ...
                        foreach (var property_00002000img_alert_0_arm in property_00002000img_alert_0)
                        {
                            ...
                            if (part != "delay" && part != "face")
                            {
                                ...
                                var texture = new Texture(property_00002000img_alert_0_arm, "Player",GameUtil.Instance.sortingLayerName_DefaultPlayer);
                                texture.shift(shift);
                        ...
                        if (headnode[stancename]?[frame.ToString()]?["head"] is MapleData headsfnode)
                        {
                            ...
                            var texture = new Texture(headsfnode, "Player", GameUtil.Instance.sortingLayerName_DefaultPlayer);
                            texture.shift(shift);
