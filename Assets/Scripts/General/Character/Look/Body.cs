...
namespace ms
{
	public class Body
	{
		...
		/*public Body(int skin, BodyDrawInfo drawinfo)
		{
		    ...
		    var bodynode = ms.wz.xml_character.getData("00002000.img");
		    var headnode = ms.wz.xml_character.getData("00012000.img");
		                    ...
		                    if (part != "delay" && part != "face")
		                    {
		                        ...
		                        switch (layer)
		                        {
		                            case Body.Layer.HAND_BELOW_WEAPON:
		                                ...
		                                var tempPoint = property_00002000img_alert_0_arm["map"]?["handMove"] ?? new Point_short();
		                                shift = shift - tempPoint;
		                                break;
		                            default:
		                                shift = new Point_short(drawinfo.get_body_position(stance, frame)) ?? new Point_short();
		                                var tempPoint1 = property_00002000img_alert_0_arm["map"]["navel"] ?? new Point_short();
