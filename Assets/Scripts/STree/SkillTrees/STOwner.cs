...
namespace NodeCanvas.SkillTrees
{
    ...
    [AddComponentMenu("NodeCanvas/ST Owner")]
    public class STOwner : GraphOwner<SkillTree>
    {
        ...
        public IState TriggerState(string stateName) { return TriggerState(stateName, SkillTree.TransitionCallMode.Normal); }
        public IState TriggerState(string stateName, SkillTree.TransitionCallMode callMode) {
            if ( behaviour != null ) {
