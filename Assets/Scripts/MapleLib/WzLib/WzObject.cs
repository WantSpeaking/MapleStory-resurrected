...
namespace MapleLib.WzLib
{
	...
	/// </summary>
	public abstract partial class WzObject : IDisposable
	{
        ...
        {
	        //AppDebug.LogWarning ($"{FullPath} don't have int subProperty");
	        return 0;
        }

        public virtual short GetShort()
        {
	        //AppDebug.LogWarning ($"{FullPath} don't have short subProperty");
	        return 0;
        }

        public virtual long GetLong()
        {
	        //AppDebug.LogWarning ($"{FullPath} don't have long subProperty");
	        return 0;
        }

        public virtual float GetFloat()
        {
	        //AppDebug.LogWarning ($"{FullPath} don't have float subProperty");
	        return 0;
        }

        public virtual double GetDouble()
        {
	        //AppDebug.LogWarning ($"{FullPath} don't have double subProperty");
	        return 0;
        }
