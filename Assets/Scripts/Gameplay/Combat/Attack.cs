...
namespace ms
{
	public class Attack
	{
		...
		public Point<short> origin = new Point<short> ();
	...
	public class MobAttack
	{
		...
		public MobAttack (int watk, Point<short> origin, int mobid, int oid)
		{
			this.type = Attack.Type.CLOSE;
			this.watk = watk;
//C++ TO C# CONVERTER CRACKED BY X-CRACKER 2017 WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: this.origin = new ms.Point<short>(origin) =
			this.origin = origin;
			this.mobid = mobid;
			this.oid = oid;
			this.valid = true;
...
//ORIGINAL LINE: explicit operator bool() const
	...
	public struct AttackUser
	{
		...
		public AttackUser (int skilllevel, ushort level, bool secondweapon, bool flip)
		{
