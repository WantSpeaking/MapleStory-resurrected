...
namespace ms_Unity
{
    public partial class FGUI_StatusBar : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            _mid = (GGroup)GetChildAt(34);
            _Right = (GGroup)GetChildAt(35);
            _FunctionPanel = (GGroup)GetChildAt(36);
            _Txt_EXP = (GTextField)GetChildAt(38);
            _Txt_Channel = (GTextField)GetChildAt(39);
            _Txt_Time = (GTextField)GetChildAt(40);
            _ProgressBar_EXP = (GProgressBar)GetChildAt(41);
            _Txt_Version = (GTextField)GetChildAt(42);
            _Bottom = (GGroup)GetChildAt(43);
            _QuestLogMini = (FGUI_QuestLogMini)GetChildAt(44);
            _Boss_HPBar = (FGUI_Boss_HPBar)GetChildAt(45);
