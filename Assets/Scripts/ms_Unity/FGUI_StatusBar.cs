...
namespace ms_Unity
{
    public partial class FGUI_StatusBar : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            _BT_FuctionCenter = (GButton)GetChildAt(31);
            _BT_DrawBG = (GButton)GetChildAt(32);
            _BT_BlacksmithShop = (GButton)GetChildAt(33);
            _BT_Debug = (GButton)GetChildAt(34);
            _mid = (GGroup)GetChildAt(35);
            _Right = (GGroup)GetChildAt(36);
            _FunctionPanel = (GGroup)GetChildAt(37);
            _Txt_EXP = (GTextField)GetChildAt(39);
            _Txt_Channel = (GTextField)GetChildAt(40);
            _Txt_Time = (GTextField)GetChildAt(41);
            _ProgressBar_EXP = (GProgressBar)GetChildAt(42);
            _Txt_Version = (GTextField)GetChildAt(43);
            _Bottom = (GGroup)GetChildAt(44);
            _QuestLogMini = (FGUI_QuestLogMini)GetChildAt(45);
            _Boss_HPBar = (FGUI_Boss_HPBar)GetChildAt(46);
