...
namespace ms_Unity
{
    public partial class FGUI_StatusBar : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            _mid = (GGroup)GetChildAt(28);
            _Right = (GGroup)GetChildAt(29);
            _FunctionPanel = (GGroup)GetChildAt(30);
            _Txt_EXP = (GTextField)GetChildAt(32);
            _Txt_Channel = (GTextField)GetChildAt(33);
            _Txt_Time = (GTextField)GetChildAt(34);
            _ProgressBar_EXP = (GProgressBar)GetChildAt(35);
