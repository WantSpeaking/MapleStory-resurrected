...
namespace ms_Unity
{
    public partial class FGUI_StatusBar : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            _mid = (GGroup)GetChildAt(32);
            _Right = (GGroup)GetChildAt(33);
            _FunctionPanel = (GGroup)GetChildAt(34);
            _Txt_EXP = (GTextField)GetChildAt(36);
            _Txt_Channel = (GTextField)GetChildAt(37);
            _Txt_Time = (GTextField)GetChildAt(38);
