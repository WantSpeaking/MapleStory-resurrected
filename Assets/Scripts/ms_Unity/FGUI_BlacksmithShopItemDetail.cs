...
namespace ms_Unity
{
    public partial class FGUI_BlacksmithShopItemDetail : GComponent
    {
        ...
        public const string URL = "ui://4916gthqwhiton9";

        public static FGUI_BlacksmithShopItemDetail CreateInstance()
        {
            return (FGUI_BlacksmithShopItemDetail)UIPackage.CreateObject("ms_Unity", "BlacksmithShopItemDetail");
        }
