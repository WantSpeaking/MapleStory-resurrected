...
namespace ms_Unity
{
    public partial class FGUI_NpcTalk : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            _Btn_OK = (GButton)GetChildAt(3);
            _Btn_YES = (GButton)GetChildAt(4);
            _Btn_No = (GButton)GetChildAt(5);
            _Btn_Accept = (GButton)GetChildAt(6);
            _Btn_Decline = (GButton)GetChildAt(7);
            _Btn_Prev = (GButton)GetChildAt(8);
            _Btn_Next = (GButton)GetChildAt(9);
            _GLoader_speaker = (GLoader)GetChildAt(10);
            _GLoader_nametag = (GLoader)GetChildAt(11);
            _Txt_name = (GTextField)GetChildAt(12);
            OnCreate();
