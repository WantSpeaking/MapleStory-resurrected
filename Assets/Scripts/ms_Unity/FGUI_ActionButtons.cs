...
namespace ms_Unity
{
    public partial class FGUI_ActionButtons : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            _Btn_Skill1 = (FGUI_Btn_Joystick_Acton)GetChildAt(6);
            _Btn_Skill2 = (FGUI_Btn_Joystick_Acton)GetChildAt(7);
            _Btn_Skill3 = (FGUI_Btn_Joystick_Acton)GetChildAt(8);
            _Btn_Skill4 = (FGUI_Btn_Joystick_Acton)GetChildAt(9);
            _GList_UseBtns = (GList)GetChildAt(11);
